    ...
    <div className="flex flex-col w-full justify-center items-center">
      ...
      <div className="grid grid-cols-3 gap-7 w-11/12 ">
        <div className="flex flex-col">
          <img className="rounded-lg" src="https://furniro-ds.s3.us-east-2.amazonaws.com/categories/category-1.png" alt="Dining-image" />
          <h1 className="font-poppins font-semibold text-xs mt-3 md:text-2xl text-center text-customBlack-300">Dining</h1>
        </div>
        <div className="flex flex-col">
          <img className="rounded-lg" src="https://furniro-ds.s3.us-east-2.amazonaws.com/categories/category-2.png" alt="Living-image" />
          <h1 className="font-poppins font-semibold text-xs mt-3 md:text-2xl text-center text-customBlack-300">Living</h1>
        </div>
        <div className="flex flex-col">
          <img className="rounded-lg" src="https://furniro-ds.s3.us-east-2.amazonaws.com/categories/category-3.png" alt="Bedroom-image" />
