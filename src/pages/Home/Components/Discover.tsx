...
const Discover = () => {
  return (
    <section className="bg-background-home bg-cover bg-center w-full min-h-screen" >
      <div className="flex w-full h-full min-h-screen justify-center items-center">
        ...
        <div className="flex flex-1 w-full h-full items-center justify-center md:justify-start">
          ...
          <div className="bg-customYellow-100 w-4/5 h-2/5 md:w-5/6 md:h-5/6 lg:h-3/4 xl:h-2/3 2xl:h-2/4 px-6 md:px-5 lg:px-10 lg:mx-7 rounded-lg">
            ...
            <Link to={"*"}>
            <button className="font-poppins font-bold text-xs md:text-base border border-customYellow-900 bg-customYellow-900 text-white px-10 py-4 mb-10 mt-4 md:px-5 md:py-3 lg:px-16 lg:py-5 hover:bg-white hover:text-customYellow-900 transition-transform duration-200 hover:scale-105">
              BUY NOW
            </button>
            </Link>
          </div>
