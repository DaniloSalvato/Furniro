      ...
      <div className="flex w-4/5 md:w-full justify-center items-center flex-wrap md:mt-0">
        ...
        {isDropdownOpen && (
          <div className="absolute top-24 md:top-20 md:left-52 bg-customBeije-500 border rounded shadow-lg p-4 z-50">
            ...
            >
              <option className="font-poppins" value="">
                Select
              </option>
              <option className="font-poppins" value="Asc">
                A-z
              </option>
              <option className="font-poppins" value="Desc">
                Z-a
              </option>
              <option className="font-poppins" value="Biggest">
                Biggest price
              </option>
              <option className="font-poppins" value="Lowest">
                Lowest price
              </option>
            </select>
          </div>
